...
- `<ruby>拠点</ruby>` — thiếu `<rt>` hoàn toàn
- `<ruby>拠点<rt></rt></ruby>` — `<rt>` rỗng
- `<ruby>拠点<rt>  </rt></ruby>` — `<rt>` chỉ whitespace

**✅ ĐÚNG:**
- `<ruby>拠点<rt>きょてん</rt></ruby>` (compound word)
- `<ruby>媒体<rt>ばいたい</rt></ruby>` (đặc thù từ vượt level N1/N2)
...
Bước 1: **Xác định level kanji** bằng `rules/kanji_jlpt_sensei.csv` (2495 kanji, mapped từ N5→N1).
